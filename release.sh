...
git commit -m "fwrolloutd: Bump version to $version"
...
echo
echo -n "scripts/rust-recipe.sh -c $(readlink -f "$(dirname "$0")") "
echo "-r yocto/meta-gardena/recipes-connectivity/fwrolloutd/fwrolloutd_$previous_version.bb"
echo
echo "*********************"
